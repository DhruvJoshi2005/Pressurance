...
export default function LeftHandView({ onBack }) {
  ...
  useEffect(() => {
    ...
    loader.load("/humanModel.fbx", (fbx) => {
      ...
      createPainZoneBox(2.2, 1, 1, "Left_UpperArm", -3.2, 4.7, -0.4);
      createPainZoneBox(1.3, 1, 1, "Left_Forearm", -5.2, 4.7, -0.3);
      createPainZoneBox(0.5, 1, 1, "Left_Wrist", -6.3, 4.7, 0.3);
      createPainZoneBox(0.5, 1, 1, "Left_Palm", -7, 4.7, 0.3);
      createPainZoneBox(0.8, 1, 1, "Left_Fingers", -7.8, 4.7, 0.6);
    });
