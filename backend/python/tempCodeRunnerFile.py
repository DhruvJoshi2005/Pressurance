...
for i, step in enumerate(steps, start=1):
    # Speak the step information asynchronously *before* the while loop
    speak_async(f"Step {i}: {step['name']}. Location: {step['location']}. How: {step['how']}. Precaution: {step['precaution']}. Duration: {step['duration']} seconds.")
    ...
    # speak("Say 'yes' to continue to the next point.")
    ...
    #             if word.lower() in ["yes", "ok", "okay", "haan", "next"]:
    #                 break
    #             else:
    #                 speak("Please say 'yes' to continue.")
    #     except sr.WaitTimeoutError:
    #         print("Listening timed out.")
    #         speak("Didn't hear anything. Please say 'yes' again.")
    #     except sr.UnknownValueError:
    #         print("Speech not recognized.")
    #         speak("Could not understand. Please say 'yes' again.")
